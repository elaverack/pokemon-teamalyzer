      ...
      <div>
        <table className="fieldSide">
          ...
          <tbody>
            <tr>
              <td
                className="stealthRock"
                title="Is Stealth Rock affecting this side of the field?"
              >
                <input type="checkbox" />
            ...
            <tr>
              <td
                className="steelsurge"
                title="Is Steelsurge affecting this side of the field?"
              >
                <input type="checkbox" />
            ...
            <tr>
              <td
                className="spikes"
                title="Are there Spikes on this side of the field?"
              >
                <label>Spikes: </label>
            ...
            <tr>
              <td
                className="screens"
                title="Is this Pok&eacute;mon protected by Reflect and/or Light Screen?"
              >
                <input type="checkbox" />
                <label>Reflect </label>
                <input type="checkbox" />
            ...
            <tr>
              <td
                className="protected"
                title="Is this Pok&eacute;mon protected?"
              >
                <input type="checkbox" />
                <label>Protect</label>
              </td>
            ...
            <tr>
              <td
                className="leechSeed"
                title="Has this Pok&eacute;mon been affected by Leech Seed?"
              >
                <input type="checkbox" />
            ...
            <tr>
              <td>
                <div
                  className="foresight"
                  title="Has this Pok&eacute;mon been revealed with Foresight or Odor Sleuth?"
                >
                  <input type="checkbox" />
            ...
            <tr>
              <td
                className="friendGuard"
                title="Is the Pok&eacute;mon protected by an ally's Friend Guard?"
              >
                <input type="checkbox" />
            ...
            <tr>
              <td
                className="battery"
                title="Is the Pok&eacute;mon boosted by an ally's Battery ability?"
              >
                <input type="checkbox" />
                <label>Battery</label>
              </td>
            ...
            <tr>
              <td
                className="switching"
                title="Is this Pok&eacute;mon switching out?"
              >
                <input type="checkbox" />
